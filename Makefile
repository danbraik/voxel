...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Tue Nov 19 21:14:09 2013
# Project:  voxel.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .obj/voxel1.0.0/ && $(COPY_FILE) --parents src/Renderer.hpp .obj/voxel1.0.0/ && $(COPY_FILE) --parents src/main.cpp src/Renderer.cpp .obj/voxel1.0.0/ && (cd `dirname .obj/voxel1.0.0` && $(TAR) voxel1.0.0.tar voxel1.0.0 && $(COMPRESS) voxel1.0.0.tar) && $(MOVE) `dirname .obj/voxel1.0.0`/voxel1.0.0.tar.gz . && $(DEL_FILE) -r .obj/voxel1.0.0
