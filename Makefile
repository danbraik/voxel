...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Wed Nov 20 22:46:17 2013
# Project:  voxel.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .obj/voxel1.0.0/ && $(COPY_FILE) --parents src/Renderer.hpp src/Chunk.hpp src/Block.hpp src/Freeflycamera.h src/Vector3d.h src/ChunkManager.hpp .obj/voxel1.0.0/ && $(COPY_FILE) --parents src/main.cpp src/Renderer.cpp src/Chunk.cpp src/Block.cpp src/Freeflycamera.cpp src/Vector3d.cpp src/ChunkManager.cpp .obj/voxel1.0.0/ && (cd `dirname .obj/voxel1.0.0` && $(TAR) voxel1.0.0.tar voxel1.0.0 && $(COMPRESS) voxel1.0.0.tar) && $(MOVE) `dirname .obj/voxel1.0.0`/voxel1.0.0.tar.gz . && $(DEL_FILE) -r .obj/voxel1.0.0
