...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Sun Dec 8 14:32:17 2013
# Project:  voxel.pro
# Template: app
...
.obj/ElectricManager.o: src/ElectricManager.cpp src/ElectricManager.hpp \
		src/VoxelEngine.hpp \
		src/Render/Renderer.hpp \
		src/Chunk/ChunkManager.hpp \
		src/Chunk/Chunk.hpp \
		...
		src/RaycastHelper.hpp \
		src/VectorTools.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o .obj/ElectricManager.o src/ElectricManager.cpp
...
.obj/BlockCxWire.o: src/Block/BlockCxWire.cpp src/Block/BlockCxWire.hpp \
		src/Block/BlockCxElec.hpp \
		src/Block/ComplexBlock.hpp \
		src/Block/Block.hpp \
		src/Render/Mesh.hpp \
		...
		src/Render/MeshVertex.hpp \
		src/VectorTools.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o .obj/BlockCxWire.o src/Block/BlockCxWire.cpp

.obj/BlockCxElec.o: src/Block/BlockCxElec.cpp src/Block/BlockCxElec.hpp \
		src/Block/ComplexBlock.hpp \
		src/Block/Block.hpp \
		src/Render/Mesh.hpp \
		src/Render/Renderer.hpp \
		src/Render/MeshVertex.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o .obj/BlockCxElec.o src/Block/BlockCxElec.cpp

.obj/BlockCxPower.o: src/Block/BlockCxPower.cpp src/Block/BlockCxPower.hpp \
		src/Block/BlockCxElec.hpp \
		src/Block/ComplexBlock.hpp \
		src/Block/Block.hpp \
		src/Render/Mesh.hpp \
		src/Render/Renderer.hpp \
		src/Render/MeshVertex.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o .obj/BlockCxPower.o src/Block/BlockCxPower.cpp
